...
- At the beginning, "read_csv()" was used to import three excel files data, and "janitor::clean_name()" was used to create analyzable variable names.

- Then, while viewing the datasets, variable names of bakers' name were found to be different. Therefore, to easily combine the datasets, full-name of "baker_name" was separated into first_name and last_name, where first_name was taken use of, as only first names were shown in both "bakes" and "results" files.

- Name format of "Jo" was found to be ""Jo"" in bakes. Quotes were deleted using "case_match()".
