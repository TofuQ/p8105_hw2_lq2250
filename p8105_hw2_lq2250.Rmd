...
- Incompatible value correction: Name format of "Jo" was found to be ""Jo"" in bakes. Quotes were deleted using "replace()".
...
- Missing data in bakes found: Two series(9-10) of bakes records and Joanne's bakes record were missing, which leads to miss-match between "bakes" and the other two dataset.Problems of completing data happened.
